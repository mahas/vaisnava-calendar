...
* **Dynamic Ecosystem Cross-Discovery (`loadEcosystemCrossDiscovery`)**: In `web/js/app.js`, queries `https://api.bhaktilib.com/v1/entities` to resolve entity URNs and cross-references Ekadasi stories and related BhaktiLib books and Devotify audio resources dynamically while preserving fallback mapping arrays.
* **Documentation**: [`docs/ecosystem_integration.md`](./docs/ecosystem_integration.md)
